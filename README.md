...
## BabyCamOS:
- Currently the Raspberry PI 4 is supported
- You can build the project from source using the Buildroot and the provided Makefile, this has to be done on Linux.
- Otherwise donwload the latest image under Releases
- install der image to an SD card
  - on linux use 
```
